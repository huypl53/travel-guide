...
export const TRIP_TEMPLATES: TripTemplate[] = [
  {
    ...
    coverEmoji: "\u{1F338}",
    locations: [
      { type: "homestay", name: "The LOCAL Dalat Hostel", lat: 11.9404, lon: 108.4383, address: "45 Truong Cong Dinh, Ward 1, Da Lat" },
      { type: "homestay", name: "Zen Valley Dalat", lat: 11.9186, lon: 108.4308, address: "12 Hoang Hoa Tham, Ward 10, Da Lat" },
      { type: "homestay", name: "Dalat De Charme Village", lat: 11.9352, lon: 108.4528, address: "Trai Mat, Da Lat" },
  ...
  },
  {
    ...
    coverEmoji: "\u{1F3EE}",
    locations: [
      { type: "homestay", name: "Hoi An Chic Homestay", lat: 15.8780, lon: 108.3260, address: "18 Le Loi, Hoi An" },
      { type: "homestay", name: "An Bang Seaside Village", lat: 15.9020, lon: 108.3510, address: "An Bang Beach, Hoi An" },
      { type: "homestay", name: "Da Nang Riverside Homestay", lat: 16.0610, lon: 108.2240, address: "Bach Dang, Hai Chau, Da Nang" },
  ...
  },
  {
    ...
    locations: [
      { type: "homestay", name: "Long Beach Bungalow", lat: 10.2115, lon: 103.9570, address: "Tran Hung Dao, Duong Dong, Phu Quoc" },
      { type: "homestay", name: "Ong Lang Beach Homestay", lat: 10.2680, lon: 103.9420, address: "Ong Lang, Phu Quoc" },
      { type: "homestay", name: "Starfish Beach House", lat: 10.3620, lon: 103.9980, address: "Rach Vem, Phu Quoc" },
  ...
  },
  {
    ...
    locations: [
      { type: "homestay", name: "Old Quarter View Homestay", lat: 21.0340, lon: 105.8510, address: "Hang Bac, Hoan Kiem, Ha Noi" },
      { type: "homestay", name: "West Lake House", lat: 21.0530, lon: 105.8260, address: "Xuan Dieu, Tay Ho, Ha Noi" },
      { type: "homestay", name: "French Quarter Stay", lat: 21.0210, lon: 105.8530, address: "Hai Ba Trung, Ha Noi" },
  ...
  },
  {
    ...
    coverEmoji: "\u{1F310}",
    locations: [
      { type: "homestay", name: "District 1 Central Homestay", lat: 10.7756, lon: 106.7019, address: "Bui Vien, Pham Ngu Lao, District 1" },
      { type: "homestay", name: "Thao Dien Village Stay", lat: 10.8030, lon: 106.7340, address: "Thao Dien, Thu Duc City" },
      { type: "homestay", name: "Homestay District 3", lat: 10.7834, lon: 106.6856, address: "Vo Thi Sau, Ward 7, District 3" },
  ...
  },
  {
    ...
    locations: [
      { type: "homestay", name: "Tam Coc Garden Homestay", lat: 20.2155, lon: 105.9400, address: "Ninh Hai, Hoa Lu, Ninh Binh" },
      { type: "homestay", name: "Trang An Retreat", lat: 20.2530, lon: 105.8900, address: "Truong Yen, Hoa Lu, Ninh Binh" },
