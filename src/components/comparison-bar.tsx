...
export function ComparisonBar({ onView }: ComparisonBarProps) {
  ...
  return (
    <div className="fixed bottom-14 md:bottom-4 left-1/2 -translate-x-1/2 z-50 bg-primary text-primary-foreground rounded-full shadow-lg px-4 py-2 flex items-center gap-3 text-sm">
